...
class _SubCategoryListItemState extends State<SubCategoryListItem> {
  ...
  addProductToCart(BuildContext ctx, int productId, int attributeId,
      int quantity, num price, bool withPop, String description) async {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: CustomNumberPicker(
              ...
              customAddButton: Icon(Icons.add, size: 26, color: Colors.black87),
              customMinusButton:
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  widget.product.salePrice != null &&
                              widget.product.salePrice != 0 ||
                          (attributes != null && attributes[0].salePrice != 0)
                      ? Text(
                          widget.product.productType == 'simple'
                              ? '${widget.product.price} ${trans(context, 'kd')}'
                              : '${attributes[0].price} ${trans(context, 'kd')}',
